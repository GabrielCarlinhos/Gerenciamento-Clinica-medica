  ...
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalToggleLabel">Alterar Paciente</h5>
    ...
    <input type="text" class="input_cadastro" id="id_paciente" name='id_paciente' readonly>
...
<div id="mostrar_cadastro_acompanhante">
    ...
    <button type ="button" class="btn btn-info" id="botao_mostrar_cadastro_acompanhante" name='botao_acompanhantes' data-bs-toggle="modal" data-bs-target="#exampleModalToggle2">Cadastrar acompanhante</button>
</div>
...
<div class="modal fade" data-bs-backdrop="static" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalToggleLabel2">Alterar Paciente</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
...
<h2 class="titulo_cadastro">Pesquisar Pacientes</h2>
    <div id="botoes_cadastro_especialidade">
    <button class='button_pesquisa' id="button_pesquisar_doutores">Pesquisar</button>
    <button class='button_incluir' onclick="window.location ='cadastro_pacientes.php'" id="button_incluir_doutores">Incluir</button>
</div>
<div id="container_pesquisa">
    <input type = "text" id="filtro_paciente">
    <select id="selecao_filtro_paciente" placeholder="Pesquisar">
<option value="nome" selected>Filtrar por nome</option>
<option value="id">Filtrar por ID</option>
<option value="nomeMae">Filtrar por nome da mãe</option>

</select>
<div class="content_pesquisa" id="content_pesquisa_paciente">
</div>
</div>
