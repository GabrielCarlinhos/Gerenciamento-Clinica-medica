...
<h2 class="titulo_cadastro">Cadastro de Doutores</h2>
    <div id="botoes_cadastro_especialidade">
    <button class='button_pesquisa' onclick="window.location='pesquisa_doutores.php'" id="button_pesquisar_doutores">Pesquisar</button>
    <button class='button_incluir' id="button_incluir_doutores">Incluir</button>
</div>
    ...
    <div id="input_doutores">
        ...
        <input type="text" class="input_cadastro" id="crm_doutor" name="crm_doutor" maxlength = "6" placeholder = "CRM">
