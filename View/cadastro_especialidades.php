...
<div class="content_cadastro" id="content_cadastro">
    <h2 class="titulo_cadastro">Cadastro de Especialidades</h2>
    <div id="botoes_cadastro_especialidade">
    <button class='button_pesquisa' onclick = "window.location ='pesquisa_especialidades.php'" id="button_pesquisar_especialidades">Pesquisar</button>
    <button class='button_incluir' id="button_incluir_especialidades">Incluir</button>
</div>
<form method='post' id="form_especialidade" action ='../Controller/processa_cadastro_especialidades.php' onSubmit="return validaDados_especialidades()">
    <div id="input_especialidades">
    <div><label for="nome_especialidade" id="nome_especialidade_label">Descrição</label>
