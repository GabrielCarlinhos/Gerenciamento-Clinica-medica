...
<head>
    ...
    <script src="../Controller/gerarRelatorioFinanceiro.js"></script>
...
<div id="content_relatorio" > 
<h2 class="titulo_cadastro">Relatório Financeiro</h2>
<div id="tabelas_relatorios">
